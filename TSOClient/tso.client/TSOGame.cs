...
namespace FSO.Client
{
    ...
    public class TSOGame : FSO.Common.Rendering.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            //using a hardcoded variable to lock behind something verified server-side anyways is just dumb
            if (File.Exists(Path.Combine(FSOEnvironment.UserDir, "admin.txt")))
